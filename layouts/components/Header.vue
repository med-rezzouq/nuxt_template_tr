    ...
    <header class="lg:bg-gradient-to-b lg:from-indigo-dark lg:to-transparent">
      ...
      >
        ...
        <nav class="flex justify-between items-center">
          ...
          <ul class="flex space-x-12 text-sm text-white">
            <li>
              <a href="#">Home</a>
            </li>
            <li>
              <a href="#" class="border-b-2 py-1">Projects </a>
            </li>
            <li>
              <a href="#">Contact us </a>
            </li>
          ...
          <ul
            class="flex justify-between space-x-12 items-center text-lg text-white"
            data-v-19f37822=""
          >
            <li>
              <a href="#">Let's call you.</a>
            </li>
            <li>
              <a href="#">
                <svg
...
header .top-menu li {
  /* prefer add style for all header li either than adding a class for each */
